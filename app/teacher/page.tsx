...
export default function TeacherHub() {
    ...
    // ✅ use replace to avoid back/forward bounce
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-950 via-black to-green-950/30 px-4 py-6 flex items-center justify-center">
            ...
            >
                {menuOpen ? <X className="h-5 w-5 text-green-300" /> : <Menu className="h-5 w-5 text-green-300" />}
            </button>
            ...
            {menuOpen && isMobile && (
                ...
                >
                    ...
                    >
                        <h3 className="text-green-300 font-semibold mb-3 text-sm">Teacher Hub</h3>
            ...
            >
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-white/60 text-sm mt-2">Choose how you want to continue</p>
                </div>
